	...
	class AQ_Block {
		...
		function parse_block($block_options) {
			$defaults = array(
				...
				'veryfirst' => false,			//column very first (foundation grid)
		...
		function before_block($instance) {
			...
			if($first == true) { // rows (foundation grid)
				if($veryfirst == false && $parent == 0 || $name == "Divider") echo '</div>';
				echo '<div class="row">';
			}

			if($size == "span1") $size_class = "one";
			elseif($size == "span2") $size_class = "two";
			elseif($size == "span3") $size_class = "three";
			elseif($size == "span4") $size_class = "four";
			elseif($size == "span5") $size_class = "five";
			elseif($size == "span6") $size_class = "six";
			elseif($size == "span7") $size_class = "seven";
			elseif($size == "span8") $size_class = "eight";
			elseif($size == "span9") $size_class = "nine";
			elseif($size == "span10") $size_class = "ten";
			elseif($size == "span11") $size_class = "eleven";
			elseif($size == "span12") $size_class = "twelve";
			
			echo '<div id="aq-block-'.$number.'" class="aq-block aq-block-'.$id_base.' '.$column_class.' '.$size_class.' columns">';
		}
		
		/* block footer */
		function after_block($instance) {
			extract($instance);
			if($name == "Column") echo '</div>';
			echo '</div>';
		}
